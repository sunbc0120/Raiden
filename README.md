...
Emulation of "Raiden" Game with Mathematica ([Blog](https://community.wolfram.com/groups/-/m/t/490143?p_p_auth=vcVT09jN)).

There are a lot of arcade games realized with MMA, including: 2048 ([2D](https://blog.wolfram.com/2014/05/09/2048/) and [3D](https://mathematica.stackexchange.com/questions/49357/poor-performance-from-graphics3d/50492?noredirect=1#comment148898_50492)), [Sokoban](https://pan.baidu.com/s/1hqipo6C), [point 24](https://demonstrations.wolfram.com/Calculating24/), Gomoku, Snake, Minesweeper and Tetris. As well as video games like [minecraft](https://mathematica.stackexchange.com/questions/19669/mathematica-minecraft) and SimCity 3000.

However, one classic scrolling shooter arcade game named ["Raiden"](https://en.wikipedia.org/wiki/Raiden_%28video_game%29) (means "thunder and lighting") is missing. Here is a prototype of that:
